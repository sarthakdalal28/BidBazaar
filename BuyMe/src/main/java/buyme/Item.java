...
public class Item {
	...
	public static void changeSQLMode() throws Exception{
		String changeMode = "SET GLOBAL sql_mode=(SELECT REPLACE(@@sql_mode,'ONLY_FULL_GROUP_BY',''));";
		Connection con = null;
		PreparedStatement ps = null;
		try {
			Class.forName("com.mysql.cj.jdbc.Driver").newInstance();
			con = DriverManager.getConnection(
					"jdbc:mysql://localhost:3306/buyme", "root",
					"password");
			ps = con.prepareStatement(changeMode);
			ps.executeUpdate();
		} catch (SQLException se) {
			throw se;
		} catch (Exception e) {
	...
	public static void disableForeignCheck() throws Exception{
		...
		try {
			...
			con = DriverManager.getConnection(
					"jdbc:mysql://localhost:3306/buyme", "root",
					"password");
			ps = con.prepareStatement(disableSQL);
			ps.executeUpdate();
		} catch (SQLException se) {
			throw se;
		} catch (Exception e) {
	...
	public static void useBuyMe() throws Exception{
		String buymeSQL = "USE buyme;";
		Connection con = null;
		PreparedStatement ps = null;
		try {
			Class.forName("com.mysql.cj.jdbc.Driver").newInstance();
			con = DriverManager.getConnection(
					"jdbc:mysql://localhost:3306/buyme", "root",
					"password");
			ps = con.prepareStatement(buymeSQL);
			ps.executeUpdate();
		} catch (SQLException se) {
			throw se;
		} catch (Exception e) {
	...
	public static void enableForeignCheck() throws Exception{
		...
		try {
			...
			con = DriverManager.getConnection(
					"jdbc:mysql://localhost:3306/buyme", "root",
					"password");
			ps = con.prepareStatement(enableSQL);
			ps.executeUpdate();
		} catch (SQLException se) {
			throw se;
		} catch (Exception e) {
	...
	public static void deleteByID(int itemID) throws Exception {
		String deleteSQL = "DELETE FROM Auction WHERE auction_id = ?";
		Connection con = null;
		PreparedStatement ps = null;
		try {
			Class.forName("com.mysql.cj.jdbc.Driver").newInstance();
