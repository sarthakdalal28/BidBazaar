			...
			<div class="item-info-container">
				...
				<div class="item-details-container">
					<div class="item-header-container">
						<p class="hdr-med">Item Name:</p>
						<div class="item-sub-header">
							<p class="hdr-lrg"><%=rs.getString("item_name") %></p>
						</div>
					...
					<div class="item-price-container">
						<p class="hdr-med">Price: $<%=rs.getFloat("initial_price") %></p>
						<p class="hdr-med">Minimum Price: $<%=rs.getFloat("min_sell_price") %></p>
		...
		<section>
			<div class="bidding-container">
				<div class="card make-bid-container">
					<p class="hdr-med">Interested in Bidding?</p>
			...
			<div class="past-bids-container">
				...
				%>
					 <div class="card past-bid">
						<div><p class="body-sml"><%=rs.getString("user_id")%></p></div>
							<div><p class="body-sml">$<%=rs.getFloat("price")%></p></div>
							<div><p class="body-sml"><%=rs.getString("time_create")%></p></div>
						</div>
				<%
					}
				%>
